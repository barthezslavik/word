...
class EntitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Entity" do
    ...
    fill_in "Article", with: @entity.article
    check "Done article" if @entity.done_article
    check "Done german" if @entity.done_german
    fill_in "English", with: @entity.english
    fill_in "German", with: @entity.german
